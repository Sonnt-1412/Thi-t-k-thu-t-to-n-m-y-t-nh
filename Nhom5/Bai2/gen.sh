...
/opt/homebrew/bin/g++-15 -std=c++17 -O2 -pipe gen_sub2.cpp -o gen_sub2
/opt/homebrew/bin/g++-15 -std=c++17 -O2 -pipe gen_sub3.cpp -o gen_sub3
echo "[Compile] Done."
...
gen_and_run gen_sub1 1 1 7
gen_and_run gen_sub1 2 8 14
gen_and_run gen_sub1 3 15 21
gen_and_run gen_sub1 4 22 28

# Subtask 2 (30 tests)
echo "[Generate] Subtask 2"
gen_and_run gen_sub2 1 29 40
gen_and_run gen_sub2 2 41 50
gen_and_run gen_sub2 3 51 60
gen_and_run gen_sub2 4 61 70

echo "[Generate] Subtask 3"
gen_and_run gen_sub3 1 71 77
gen_and_run gen_sub3 2 78 84
gen_and_run gen_sub3 3 85 91
gen_and_run gen_sub3 4 92 100
