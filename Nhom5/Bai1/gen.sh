...
gen_and_run gen_sub1 2 21 28 
gen_and_run gen_sub1 3 29 40
gen_and_run gen_sub1 4 41 50

# Subtask 2 (30 tests)
echo "[Generate] Subtask 2"
gen_and_run gen_sub2 1 51 60
gen_and_run gen_sub2 2 61 70
gen_and_run gen_sub2 3 71 85
gen_and_run gen_sub2 4 86 100
